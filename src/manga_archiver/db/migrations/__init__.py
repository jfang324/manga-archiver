...
DEFAULT_DATABASE_VERSION = "v1.1.0"  # This should be synced up with the latest version of the app
DEFAULT_GOOGLE_DRIVE_VERSION = (
    "v1.1.0"  # This should be synced up with the latest version of the app
)
