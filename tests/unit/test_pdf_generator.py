...
class TestPdfGeneratorGenerate:
    ...
    @patch("os.getcwd")
    @patch("os.path.join")
    def test_generate_converts_rgba_to_rgb(
        self, mock_join, mock_getcwd, mock_image_open
    ):
    ...
    @patch("os.getcwd")
    @patch("os.path.join")
    def test_generate_converts_palette_to_rgb(
        self, mock_join, mock_getcwd, mock_image_open
    ):
    ...
    @patch("os.getcwd")
    @patch("os.path.join")
    def test_generate_uses_custom_output_path(
        self, mock_join, mock_getcwd, mock_image_open
    ):
